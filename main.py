    ...
    <body>
        <div class="card">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nameInput" value="" placeholder="例如：草屯家、頂樓曬衣場">
            </div>
            ...
            <div class="form-group">
                <label>4. 精準經緯度座標 (選填：想更精準再打)</label>
                <input type="text" id="latlonInput" value="" placeholder="例如：23.978,120.686">
